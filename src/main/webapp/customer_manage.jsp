...
<html>
  ...
  <!-- 编辑窗口 -->
 <div id="win" class="easyui-window" title="客户编辑窗口" style="width:500px;height:300px"
	  data-options="iconCls:'icon-save',modal:true,closed:true">
	 <form id = "editForm" method="post">
<%--		提供id隐藏域 --%>
		 <input type="hidden" name="id">
		 客户姓名:<input type="text" name="name" class="easyui-validatebox"
					 data-options="required:true"/><br/> 客户性别:
		 ...
		 <a id="saveBtn" href="#" class="easyui-linkbutton"
			data-options="iconCls:'icon-save'">保存</a> </form>
...
columns:[[
	...
	},
	{
	  ...
	  //打开编辑窗口
		  ...
		  //修改数据
		  $("#editBtn").click(function() { //判断只能选择一行
...
//save data
		  $("#saveBtn").click(function(){
		  	$("#editForm").form("submit",{
		  		//url:submit to an houtai address
